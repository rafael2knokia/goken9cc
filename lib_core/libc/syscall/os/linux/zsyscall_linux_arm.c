// generated by scripts/mksyscall.sh syscall/os/linux/syscall_linux_arm.decl -- DO NOT EDIT
...
{
	return (int)_syscall6(SYS_ftruncate64, (long)fd, (long)lo, (long)hi, 0, 0, 0);
}
