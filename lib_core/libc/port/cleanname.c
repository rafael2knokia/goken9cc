...
/* cleanname() (include/os/path.h), plain copy of principia's
 * lib_core/libc/port/cleanname.c. Found blocking utilities/files/mv.c
 * (which calls it on each argv[] path before comparing/using it).
 */
